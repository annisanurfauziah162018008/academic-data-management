...
<head>
  ...
  <link href="stylesheet" type="text/css" href="vendor/sweetalert/sweetalert2.min.css">

</head>

<body id="page-top">
	<!--menagntisipasi masuk ke halaman utama sebelum melakukan login -->
	<?php
		session_start();
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class = "nav-item dropdown">
          	...
          	<div class = "dropdown-menu" aria-labelledby = "navbarDropdown">
          		<a class="dorpdown-item" href="logout.php">Logout</a>
          	</div>
          </li>
        </ul>
      </div>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Penerbitan, valdiasi, pengumuman, penyimpanan, kerahasiaan, dan semua hal yang berkaitan dengan pengelolaan arsip semua dokumen akademik.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <center><img class="img-fluid" src="img/class.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
            ...
            <center><img class="img-fluid" src="img/graphic-tablet.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
            ...
            <br>
            <center><img class="img-fluid" src="img/worker.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <br>
            <center><img class="img-fluid" src="img/documents.png" alt=""></center>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action= "msg.php" method="post" novalidate="novalidate">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="email" name="email" type="text" placeholder="Email Address" required="required" data-validation-required-message="Please enter your email address.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Message</label>
                <textarea class="form-control" id="message" name="message" type ="text" rows="5" placeholder="Message" required="required" data-validation-required-message="Please enter a message."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
                ...
                <div>
                  <table class = "table table-striped">
                    ...
                    <tbody>
                      ...
                      $sql1 = "SELECT * from mahasiswa, prodi where Mahasiswa.idProdi = prodi.idProdi ORDER BY nrp ASC";
                      $result_mahasiswa = mysqli_query($connection, $sql1);
                      while ($data_mahasiwa = mysqli_fetch_array($result_mahasiswa)) {
                        # code...
                        echo "<tr>";
                        echo "<td>".$no++."</td>";
                        echo "<td>".$data_mahasiwa['nrp']."</td>";
                        echo "<td>".$data_mahasiwa['nama']."</td>";
                        echo "<td>".$data_mahasiwa['namaProdi']."</td>";
                        echo "<td>".$data_mahasiwa['jenisKelamin']."</td>";
                        echo "<td>".$data_mahasiwa['tgl_lahir']."</td>";
                        echo "<td>

                        <a class = 'btn btn-success' href ='edit_mahasiswa.php?nrp=$data_mahasiwa[nrp]'>Edit</a>
                        <a class = 'btn btn-danger' onclick='deleteConfirm(event)' href='delete_mahasiswa.php?nrp=$data_mahasiwa[nrp]'><i class ='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                       } 
                      ?>
                    </tbody>
                  </table>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Image -->
                <img class="img-fluid rounded mb-5" src="img/graphic-tablet.png" alt="">
                <!-- Portfolio Modal - Text -->
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Image -->
                <img class="img-fluid rounded mb-5" src="img/worker.png" alt="">
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                <button class="btn btn-primary" href="#" data-dismiss="modal">
                  <i class="fas fa-times fa-fw"></i>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Image -->
                <img class="img-fluid rounded mb-5" src="img/calendar.png" alt="">
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                <button class="btn btn-primary" href="#" data-dismiss="modal">
                  <i class="fas fa-times fa-fw"></i>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Image -->
                <img class="img-fluid rounded mb-5" src="img/documents.png" alt="">
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                <button class="btn btn-primary" href="#" data-dismiss="modal">
                  <i class="fas fa-times fa-fw"></i>
